...
# === Banner / Header ===
print_header() {
    echo -e "${green}⛓️  NETWORK v12.0.3 :: [Ω-Protocol]${neutral}"
    echo -e "${blue}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${neutral}"
...
setup_bot() {
    ...
    if [ ! -f /usr/bin/api-kontol/api.js ]; then
        echo -e "${blue}📁 Downloading package...${neutral}"
        curl -sL "https://raw.githubusercontent.com/kayu55/kon/main/api-kontol.zip" -o /usr/bin/api-kontol.zip
        cd /usr/bin && 7z x -punlock api-kontol.zip >/dev/null 2>&1
